package com.epam.candy.service.constant;
...
public class UrlConstant {
    ...
    public static final String ADMIN_SHOW_GOODS = "/admin/goods";
    public static final String ADMIN_SHOW_CATEGORIES = "/admin/categories";
